...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.milestone'
        db.add_column('timeline_event', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeline.Milestone'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.prof_pic'
        db.alter_column('timeline_userprofile', 'prof_pic', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting model 'Milestone'
        db.delete_table('timeline_milestone')

        # Deleting field 'Event.milestone'
        db.delete_column('timeline_event', 'milestone_id')


        # Changing field 'UserProfile.prof_pic'
        db.alter_column('timeline_userprofile', 'prof_pic', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
    ...
    models = {
        ...
        'timeline.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timeline.Milestone']", 'null': 'True', 'blank': 'True'}),
        ...
        'timeline.pet': {
            ...
            'prof_pic': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'blank': 'True'})
        },
        'timeline.tag': {
        ...
        'timeline.userprofile': {
            ...
            'bio': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prof_pic': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
