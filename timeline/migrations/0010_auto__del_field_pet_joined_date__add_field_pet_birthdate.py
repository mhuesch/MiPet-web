...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pet.joined_date'
        db.delete_column('timeline_pet', 'joined_date')

        # Adding field 'Pet.birthdate'
        db.add_column('timeline_pet', 'birthdate',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pet.joined_date'
        db.add_column('timeline_pet', 'joined_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today, blank=True),
                      keep_default=False)

        # Deleting field 'Pet.birthdate'
        db.delete_column('timeline_pet', 'birthdate')
